...
Route::prefix('public-relations')->name('public-relations.')->middleware(['role:super_admin_yayasan|admin_yayasan|pengawas_yayasan|admin_unit|humas_unit|kepala_sekolah'])->group(function () {
