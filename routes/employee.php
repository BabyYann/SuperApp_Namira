...
Route::prefix('employee')->name('employee.')->middleware(['role:teacher|staff_unit|staff_yayasan|super_admin_yayasan|admin_yayasan|pengawas_yayasan|admin_unit', 'feature:feature_employee'])->group(function () {
