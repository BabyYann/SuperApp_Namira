...
Route::prefix('sarpar')->name('sarpar.')->middleware(['role:super_admin_yayasan|admin_yayasan|pembina_yayasan|pengawas_yayasan|staff_yayasan|admin_unit|staff_unit|koordinator_sarpar|kepala_sekolah|teacher', 'feature:feature_sarpar'])->group(function () {
