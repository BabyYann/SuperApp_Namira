...
<head>
    ...
    <title>403 - Akses Ditolak | SuperApp Namira</title>
    <!-- Google Fonts -->
    ...
    <style>
        ...
        /* Digital Shield Pulsing Animation */
        ...
        /* Floating Animation for Guard Mascot */
...
<body class="min-h-screen bg-[#F8FAFC] flex items-center justify-center p-6 relative overflow-hidden">
    ...
    <div class="absolute top-[-20%] right-[-10%] w-[600px] h-[600px] bg-amber-500/5 rounded-full blur-[120px] pointer-events-none"></div>
    <div class="absolute bottom-[-20%] left-[-10%] w-[500px] h-[500px] bg-red-500/5 rounded-full blur-[100px] pointer-events-none"></div>
    ...
    <main class="relative bg-white border border-slate-100 rounded-[2.5rem] p-8 sm:p-12 max-w-xl w-full text-center shadow-[0_20px_50px_rgba(0,0,0,0.03)] transition-all duration-300">
        ...
        <div class="w-48 h-48 mx-auto mb-8 animate-float relative flex items-center justify-center">
            <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-full h-full">
                ...
                <!-- Glowing Digital Shield (Front) -->
                <g class="animate-shield">
                    <!-- Outer Glowing Ring -->
                    <circle cx="100" cy="140" r="32" fill="none" stroke="#F59E0B" stroke-width="2" stroke-dasharray="6 4" opacity="0.7" />
                    <!-- Shield Base -->
                    <path d="M100 115C112 115 124 121 124 135C124 152 104 163 100 165C96 163 76 152 76 135C76 121 88 115 100 115Z" fill="#F59E0B" />
                    <!-- Inner Shield Decor -->
                    <path d="M100 121C107.5 121 116 125 116 135C116 147 103 155 100 157C97 155 84 147 84 135C84 125 92.5 121 100 121Z" fill="#D97706" />
                    <!-- Handcuff / Keyhole icon on shield -->
                    <rect x="96" y="134" width="8" height="12" rx="2" fill="#FFFBEB" />
                    <circle cx="100" cy="132" r="3.5" fill="#FFFBEB" />
                </g>
            </svg>
        </div>

        <!-- Error Code -->
        <span class="inline-flex px-4 py-1.5 bg-amber-50 border border-amber-100 text-amber-700 text-xs font-bold rounded-2xl uppercase tracking-wider mb-4 shadow-sm">
        ...
        <p class="text-slate-500 font-medium text-sm leading-relaxed max-w-md mx-auto mb-8">
            {{ $exception->getMessage() ?: 'Wira (Mascot Penjaga) mendeteksi bahwa akun Anda tidak memiliki hak akses atau izin yang sesuai untuk membuka halaman ini.' }}
        </p>
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            <a href="/dashboard" class="w-full sm:w-auto px-8 py-3 bg-amber-500 hover:bg-amber-600 text-white font-extrabold text-xs tracking-wider uppercase rounded-2xl transition-all active:scale-95 shadow-md shadow-amber-500/20">
                Ke Beranda Utama
            </a>
        </div>
